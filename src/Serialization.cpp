...
namespace
{
    ...
    struct SavedAttributeBreakpointV6
    {
        std::uint32_t level = 0;
    ...
    // -------------------------------------------------------------------------
    // Write one V6 Attribute breakpoint table.
    // -------------------------------------------------------------------------

    bool WriteAttributeBreakpointTable(
        SKSE::SerializationInterface *serialization,
        const std::vector<Settings::AttributeBreakpoint> &breakpoints)
    {
        ...
        {
            SKSE::log::error(
                "Cannot serialize invalid Attribute "
                "breakpoint count {}.",
                breakpoints.size());
        ...
        {
            SKSE::log::error(
                "Cannot serialize Attribute breakpoint "
                "table without a level 0 breakpoint.");
            ...
            ++i)
        {
            ...
            SavedAttributeBreakpointV6 saved{};
    ...
    // -------------------------------------------------------------------------
    // Read one V6 Attribute breakpoint table.
    // -------------------------------------------------------------------------

    bool ReadAttributeBreakpointTable(
        SKSE::SerializationInterface *serialization,
        std::uint32_t &bytesReadTotal,
        std::uint32_t recordLength,
        std::vector<Settings::AttributeBreakpoint> &output)
    {
            ...
            ++i)
        {
            ...
            {
                SKSE::log::error(
                    "Serialized Attribute breakpoint table "
                    "does not start at level 0.");
            ...
            {
                SKSE::log::error(
                    "Serialized Attribute breakpoint "
                    "table is not strictly sorted.");
